...
public class ContactServiceTest {
	...
	//calls on addContact passing first, last, phone, address
	//then validates if it is working using getters to validate
	...
	//add 3 contacts via addContact to delete objects at ID 1 check 
	//that there is no object there
	...
	//create contact and validate the phone number
	//edit phone then revalidate
	@DisplayName("Test editing phon number")
	@Test
	void testEditPhone() {
		String firstName = "Greg";
		String lastName = "Hoffman";
	...
	//edit first name then revalidate
	...
	//create contact and then validate address
	//edit address then revalidate
